...
const UpdateCategory = ({ category }) => {
  ...
  return (
    <div className="mt-5 p-2.5 border border-neutral-200 rounded-xl">
      <h4 className="text-lg font-medium">Update Category</h4>
      ...
      <div className="flex items-center justify-center">
        <form
          ...
          className="mt-5 space-y-5 w-full md:w-[50%] flex flex-col items-start justify-center"
        >
          ...
          <button
            type="submit"
            className="w-full py-2.5 bg-orange-600 text-white rounded-lg text-sm shadow-sm cursor-pointer"
          >
            Update Category
          </button>
        </form>
